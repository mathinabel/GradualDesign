package com.qu.vr.examples.unity.project.fangdouyinnet;
...
import com.qu.vr.examples.unity.project.app.App;
import com.qu.vr.examples.unity.project.fangdouyinnet.viewpager.OnViewPagerListener;
import com.qu.vr.examples.unity.project.fangdouyinnet.viewpager.ViewPagerLayoutManager;

import java.util.ArrayList;
import java.util.List;

public class FangDouYinNetAc extends AppCompatActivity {
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
          ...
          //  holder.videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+ videos[position%2]));
           ...
           holder.videoView.setMediaController(new MediaController(FangDouYinNetAc.this));
         ...
         //   holder.videoView.setVideoPath("http://www.youdiandongxigame.top/mp4/5.mp4");
          //  holder.videoView.setVideoURI(Uri.parse("http://www.youdiandongxigame.top/mp4/5.mp4"));
        }
